...
import { Home, Auth, Orders, Tables, Menu, Dashboard, Kitchen, Inventory, Reservations, Workforce, Reports } from "./pages";
...
function Layout() {
  ...
  const routes = (
    <Routes>
      ...
      <Route path="/reports" element={<ProtectedRoutes roles={["Admin"]}><Reports /></ProtectedRoutes>} />
